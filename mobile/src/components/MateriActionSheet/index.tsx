...
const MateriActionSheet = ({
  ...
  return (
    ...
    >
      {/*
       * Wrapping in BottomSheetScrollView is what actually lets the sheet
       * measure its content and appear. Of the four filter sheets in the app,
       * only AssesmentActionSheet had this -- and it was the only "Filter"
       * button that did anything when tapped. Removing the hardcoded
       * height: 400 here (already done) was not enough on its own.
       */}
                  ...
                  <Button
                    ...
                    onPress={() => {
                      if (
                        ...
                        const data = querySheet.filter.filter(
                          itm => itm.id !== item.id,
                        );
                  ...
                  <Button
                    ...
                    onPress={() => {
                      if (
                        ...
                        const data = querySheet.type.filter(
                          itm => itm.id !== item.id,
                        );
