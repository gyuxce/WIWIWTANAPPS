...
const PaymentScreen = ({ amount = null }: Props) => {
  ...
  const encryptAndConfirm = async () => {
    ...
    if (
      ...
      error = "Mohon isi semua kolom data kartu kredit";
    }

    //type validation
    if (!/^\d{13,19}$/.test(formData.cardNumber!)) {
      error = t("card_validation_number");
    }
    if (!/^[A-Za-z ]{2,}$/.test(formData.name!)) {
      error = t("card_validation_name");
    }
    if (!/^\d{3}$/.test(formData.cvc!)) {
      error = t("card_validation_cvc");
    }
    if (!/^(0?[1-9]|1[0-2])$/.test(formData.expiry_month!)) {
      error = t("card_validation_expiry_month");
    }
    if (!/^\d{1,2}$/.test(formData.expiry_year!)) {
      error = t("card_validation_expiry_year");
    }
  ...
  const getBankName = (channel: string | undefined): string => {
    ...
    switch (channel) {
      case "SMBC":
        result = "Bank SMBC (Sumitomo Mitsui Banking Corporation)";
        break;
      case "BCA":
        result = "Bank BCA (Bank Central Asia)";
        break;
      case "BSI":
        result = "Bank BSI (Bank Syariah Indonesia)";
        break;
      case "BNC":
        result = "Bank BNC (Bank Neo Commerce)";
        break;
      case "BNI":
        result = "Bank BNI (Bank Negara Indonesia)";
        break;
      case "CIMB":
        result = "Bank CIMB Niaga";
        break;
      case "BRI":
        result = "Bank BRI (Bank Rakyat Indonesia)";
        break;
    }
    return result;
  };
              ...
              <View>
                ...
                >
                  ...
                  {payment && payment.status === 1
                    ? numberToRupiah(payment.total)
                    : amount
                    ? numberToRupiah(amount)
                    : numberToRupiah(transaction?.total_amount)}
                </Text>
              </View>
            )}
            {canCreatePayment && (
              <View>
                ...
                {!isLoading && methods.qr && methods.qr.enabled === true && (
                  <View>
                    ...
                    >
                      <SelectButton
                        label="QRIS"
                        logo={images.logoQris}
                        onPress={() =>
                          handleFormChange("QRIS", "provider", "QRIS")
                        }
                ...
                {!isLoading &&
                  ...
                  methods.virtualAccount.enabled === true && (
                    <View>
                      <View
                        style={{
                          backgroundColor: colors.stone100,
                      ...
                      >
                        {methods.virtualAccount.acceptedChannels.includes(
                          "SMBC",
                        ) && (
                          <SelectButton
                            label="Virtual Account"
                            logo={images.logoSmbc}
                            onPress={() =>
                              handleFormChange(
                                "VIRTUAL_ACCOUNT",
                                "bank",
                        ...
                        {methods.virtualAccount.acceptedChannels.includes(
                          ...
                          <SelectButton
                            ...
                            logo={images.logoBca}
                            onPress={() =>
                              handleFormChange("VIRTUAL_ACCOUNT", "bank", "BCA")
                            }
                            selected={
                              method === "VIRTUAL_ACCOUNT" &&
                              formData.bank === "BCA"
                        ...
                        {methods.virtualAccount.acceptedChannels.includes(
                          ...
                          <SelectButton
                            ...
                            logo={images.logoBsi}
                            onPress={() =>
                              handleFormChange("VIRTUAL_ACCOUNT", "bank", "BSI")
                            }
                            selected={
                              method === "VIRTUAL_ACCOUNT" &&
                              formData.bank === "BSI"
                        ...
                        {methods.virtualAccount.acceptedChannels.includes(
                          ...
                          <SelectButton
                            ...
                            logo={images.logoBnc}
                            onPress={() =>
                              handleFormChange("VIRTUAL_ACCOUNT", "bank", "BNC")
                            }
                            selected={
                              method === "VIRTUAL_ACCOUNT" &&
                              formData.bank === "BNC"
                        ...
                        {methods.virtualAccount.acceptedChannels.includes(
                          ...
                          <SelectButton
                            ...
                            logo={images.logoBni}
                            onPress={() =>
                              handleFormChange("VIRTUAL_ACCOUNT", "bank", "BNI")
                            }
                            selected={
                              method === "VIRTUAL_ACCOUNT" &&
                              formData.bank === "BNI"
                        ...
                        {methods.virtualAccount.acceptedChannels.includes(
                          ...
                          <SelectButton
                            ...
                            logo={images.logoBri}
                            onPress={() =>
                              handleFormChange("VIRTUAL_ACCOUNT", "bank", "BRI")
                            }
                            selected={
                              method === "VIRTUAL_ACCOUNT" &&
                              formData.bank === "BRI"
                    ...
                    <View>
                      ...
                      >
                        {methods.ewallet.acceptedChannels.includes("DANA") && (
                          <SelectButton
                            label="E-Wallet"
                            logo={images.logoDana}
                            onPress={() =>
                              handleFormChange("EWALLET", "provider", "DANA")
                            }
                            selected={
                              method === "EWALLET" &&
                              formData.provider === "DANA"
                            }
                          />
                        )}
                        {methods.ewallet.acceptedChannels.includes("OVO") && (
                          <SelectButton
                            ...
                            logo={images.logoOvo}
                            onPress={() =>
                              handleFormChange("EWALLET", "provider", "OVO")
                            }
                            selected={
                              method === "EWALLET" &&
                              formData.provider === "OVO"
                            }
                          />
                        )}
                        {methods.ewallet.acceptedChannels.includes(
                          "SHOPEEPAY",
                        ) && (
                          <SelectButton
                            label="E-Wallet"
                            logo={images.logoShopeepay}
                            onPress={() =>
                              handleFormChange(
                                "EWALLET",
                                "provider",
                    ...
                    <View>
                      ...
                      >
                        {methods.card.acceptedChannels.includes("VISA") && (
                          <SelectButton
                            label="Credit Card"
                            logo={images.logoVisa}
                            onPress={() =>
                              handleFormChange("CARD", "provider", "VISA")
                            }
                            selected={
                              method === "CARD" && formData.provider === "VISA"
                            }
                          />
                        )}
                        {methods.card.acceptedChannels.includes(
                          "MASTERCARD",
                        ) && (
                          <SelectButton
                            label="Credit Card"
                            logo={images.logoMastercard}
                            onPress={() =>
                              handleFormChange("CARD", "provider", "MASTERCARD")
                            }
                            selected={
                              method === "CARD" &&
                              formData.provider === "MASTERCARD"
                            }
                          />
                        )}
                        {methods.card.acceptedChannels.includes("JCB") && (
                          <SelectButton
                            ...
                            logo={images.logoJcb}
                            onPress={() =>
                              handleFormChange("CARD", "provider", "JCB")
                            }
                            selected={
                              method === "CARD" && formData.provider === "JCB"
                            }
                          />
                        )}
                      </View>
            ...
            {isOngoingPayment && !isLoading && (
              <View>
                    ...
                    <View>
                      ...
                      >
                        ...
                        <View>
                          ...
                          >
                            {getBankName(payment?.va_channel)}
                          </Text>
                        </View>
                      </View>
                      <View
                  ...
                  <View>
                    {!payment?.response_url && (
                      <View>
                        ...
                        >
                          {t("pivot_method_card_description")}
                        </Text>
                        <View>
                          <View style={styles.formInput}>
                            <TextInput
                              placeholderTextColor={colors.grey500}
                              style={styles.formInputColor}
                              placeholder={t("pivot_method_card_form_name")}
                              onChangeText={text =>
                                handleFormChange("CARD", "name", text)
                              }
                            />
                          </View>
                          <View style={styles.formInput}>
                            <TextInput
                              placeholderTextColor={colors.grey500}
                              style={styles.formInputColor}
                              placeholder={t("pivot_method_card_form_number")}
                              onChangeText={text =>
                                handleFormChange("CARD", "cardNumber", text)
                              }
                            />
                          </View>
                          <View
                          ...
                          >
                            ...
                            >
                              <TextInput
                                ...
                                placeholder="MM"
                                onChangeText={text =>
                                  handleFormChange("CARD", "expiry_month", text)
                                }
                              />
                            </View>
                            <View
                            ...
                            >
                              <TextInput
                                ...
                                placeholder="YY"
                                onChangeText={text =>
                                  handleFormChange("CARD", "expiry_year", text)
                                }
                              />
                            </View>
                            <View
                            ...
                            >
                              <TextInput
                                ...
                                secureTextEntry
                                onChangeText={text =>
                                  handleFormChange("CARD", "cvc", text)
                                }
                              />
                            </View>
                          </View>
                    ...
                    {payment &&
                      ...
                      !["FAILED", "EXPIRED", "SUCCESS"].includes(
                        payment.charge_status,
                      ) && (
                        <View
                          style={{
                            ...
                            onNavigationStateChange={(
                              ...
                              if (
                                navState.url.includes(
                                  payment?.response_redirect_success!,
                                )
                              ) {
                                checkStatus();
                              } else if (
                                navState.url.includes(
                                  payment?.response_redirect_failed!,
                                )
                              ) {
                                checkStatus();
                              } else if (
                                navState.url.includes(
                                  payment?.response_redirect_expired!,
                                )
                              ) {
                                checkStatus();
                              }
                ...
                {method === "EWALLET" && (
                  ...
                  >
                    {t("pivot_method_ewallet_description")}
                  </Text>
                )}
                {/* QRIS DETAILS */}
                {method === "QR" && (
                  <View>
                    ...
                    >
                      <QRCode value={payment?.qr_content} size={240} />
                    </View>
                    {/* <View style={{
                    width: "100%",
                    backgroundColor: "#eee",
              ...
              <Text style={{
                ...
                >
                  ...
                  {(method !== "CARD" ||
                    (method === "CARD" && payment?.response_url)) && (
                    <Button
                      style={{ paddingVertical: scaledVertical(25) }}
                  ...
                  {payment && payment.simulation && (
                    <Button
                      ...
                      onPress={() => {
                        openUrl(payment.simulation ?? null);
                      }}
                    />
                  )}
                </View>
