...
/**
                *
                * @OA\Get(
                * path="/cms/finance/payment-content-items",
                ...
                * security={{"bearerAuth":{}}},
                * @OA\Response(response=200, description="return PaymentContentItem Model", @OA\JsonContent()),
                * )
                */
               
class DocPaymentContentItemControllerIndexSwagger  {
