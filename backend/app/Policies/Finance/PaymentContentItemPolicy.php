...
class PaymentContentItemPolicy {
    ...
    public function view(?User $user, PaymentContentItem $row)
    {
        if(!$this->allow) {
            return  Response::deny('You can not access this data.');
        }
    ...
    public function update(?User $user, PaymentContentItem $row)
    {
        return Response::allow();
        // return  Response::deny('You can not access this data.');
    }

    public function delete(?User $user, PaymentContentItem $row)
    {
        return Response::allow();
        // return  Response::deny('You can not access this data.');
    }
    ...
    public function forceDelete(?User $user, PaymentContentItem $row)
    {
        return Response::allow();
        // return  Response::deny('You can not access this data.');
    }
