...
class PaymentContentPolicy {
    ...
    public function view(?User $user, PaymentContent $row)
    {
        if(!$this->allow) {
            return  Response::deny('You can not access this data.');
        }
    ...
    public function update(?User $user, PaymentContent $row)
    {
        return Response::allow();
        // return  Response::deny('You can not access this data.');
    }

    public function delete(?User $user, PaymentContent $row)
    {
        return Response::allow();
        // return  Response::deny('You can not access this data.');
    }
    ...
    public function forceDelete(?User $user, PaymentContent $row)
    {
        return Response::allow();
        // return  Response::deny('You can not access this data.');
    }
