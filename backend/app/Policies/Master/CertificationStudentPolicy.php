...
class CertificationStudentPolicy
{
...
//}
    ...
    public function view(?User $user, CertificationStudent $row)
    {
        if(!$this->allow) {
            return  Response::deny('You can not access this data.');
        }
    ...
    public function update(?User $user, CertificationStudent $row)
    {
        return Response::allow();
        // return  Response::deny('You can not access this data.');
    }

    public function delete(?User $user, CertificationStudent $row)
    {
        return Response::allow();
        // return  Response::deny('You can not access this data.');
    }
    ...
    public function forceDelete(?User $user, CertificationStudent $row)
    {
        return Response::allow();
        // return  Response::deny('You can not access this data.');
    }
