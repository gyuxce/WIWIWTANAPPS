...
class ContentNotificaionPolicy
{
    ...
    public function view(?User $user, ContentNotification $row)
    {
        if(!$this->allow) {
            return  Response::deny('You can not access this data.');
        }
    ...
    public function update(?User $user, ContentNotification $row)
    {
        return Response::allow();
        // return  Response::deny('You can not access this data.');
    }

    public function delete(?User $user, ContentNotification $row)
    {
        return Response::allow();
        // return  Response::deny('You can not access this data.');
    }
    ...
    public function forceDelete(?User $user, ContentNotification $row)
    {
        return Response::allow();
        // return  Response::deny('You can not access this data.');
    }
