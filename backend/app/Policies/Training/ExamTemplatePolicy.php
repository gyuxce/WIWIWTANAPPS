...
class ExamTemplatePolicy {
    ...
    public function view(?User $user, ExamTemplate $row)
    {
        if(!$this->allow) {
            return  Response::deny('You can not access this data.');
        }
    ...
    public function update(?User $user, ExamTemplate $row)
    {
    return Response::allow();
    // return  Response::deny('You can not access this data.');
    }

    public function delete(?User $user, ExamTemplate $row)
    {
        return Response::allow();
        // return  Response::deny('You can not access this data.');
    }
    ...
    public function forceDelete(?User $user, ExamTemplate $row)
    {
        return Response::allow();
        // return  Response::deny('You can not access this data.');
    }
