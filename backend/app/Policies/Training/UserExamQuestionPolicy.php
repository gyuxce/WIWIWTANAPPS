...
class UserExamQuestionPolicy {
    ...
    public function view(?User $user, UserExamQuestion $row)
    {
        if(!$this->allow) {
            return  Response::deny('You can not access this data.');
        }
    ...
    public function update(?User $user, UserExamQuestion $row)
    {
    return Response::allow();
    // return  Response::deny('You can not access this data.');
    }

    public function delete(?User $user, UserExamQuestion $row)
    {
    return Response::allow();
    // return  Response::deny('You can not access this data.');
    }
    ...
    public function forceDelete(?User $user, UserExamQuestion $row)
    {
    return Response::allow();
    // return  Response::deny('You can not access this data.');
    }
