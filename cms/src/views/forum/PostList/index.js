...
import { AdaptableCard, CardItemForum } from 'components/shared';
...
const Page = () => {
  const { getListForumPost, forumPostList, metaForumPostList, getTopicsForum, forumTopicsList } = useForum();
  ...
  return (
    <div>
      <AdaptableCard className="rounded-2xl border-none" bodyClass="p-6">
        <p className="text-h3 font-opificio text-second-200 mb-6">Daftar Postingan</p>
        ...
        <div className="mt-6 flex justify-between">
          <div className="flex">
            <Pagination
              total={metaForumPostList?.last_page}
              currentPage={metaForumPostList?.currentPage}
