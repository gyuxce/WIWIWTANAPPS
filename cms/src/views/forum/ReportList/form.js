    ...
    <div className="pr-5">
      <AdaptableCard className="rounded-2xl border-none">
        <div className="flex justify-start items-center space-x-[0.5rem] mb-[1.5rem]">
          ...
          <div>
            <Link className="text-gray-600" to={PageConfig.url}>{PageConfig.moduleTitle}</Link>
          </div>
          <div>
            <ArrowRightSvg />
          </div>
          <div className="text-main-100">
            {`${title ?? 'Add New'} ${PageConfig.moduleTitle}`}
          </div>
        </div>
                ...
                <FormContainer className="text-sm">
                  ...
                  <FormItem invalid={errors.name && touched.name} errorMessage={errors.name}>
                    <Field name="name">
                      {({ field, form }) => (
                        <div>
                          <p className="text-gray-800 font-bold leading-[21px] mb-[.25rem]">
                            Name
                          </p>
                          <Input
                            value={values.name}
