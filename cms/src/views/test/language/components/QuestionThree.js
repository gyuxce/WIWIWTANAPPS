      ...
      <div className="bg-white py-4 px-6 border-none rounded-b-xl rounded-t-none ">
        ...
        <div>
          <p className="text-black leading-[21px] mb-2">
            Konten Membaca <span className="text-red-600">*</span>
          </p>
          <ReactQuill
            ...
            value={questionActive?.description}
            onChange={(val) => {
            ...
            formats={formats}
          />
          {questionActive?.description?.length > 1000 && (
            <p className="text-sm text-red-600">Konten melebihi 1000 karakter</p>
          )}
        </div>
