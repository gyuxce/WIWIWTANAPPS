...
export const Tools = (props) => {
  ...
  const handleExport = async () => {
    setIsExporting(true);
    await exportData('xlsx', apiExport, 'riwayat_pelatihan', props.localState.params);
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center space-x-[1rem]">
          ...
          {PageConfig.enableSearchTools && (
            <TableSearch
              size="md"
              placeholder="Cari kelas virtual"
        ...
        <div className="flex justify-end items-center space-x-[0.5rem]">
          ...
          {PageConfig.enableCreate && (
            <Button
              ...
              className="bg-white !px-3 !py-2 flex items-center !rounded"
            >
              <div className="mt-1 ml-1 !font-goth text-black !font-normal text-sm">Buat Acara</div>
            </Button>
          )}
        </div>
      </div>
