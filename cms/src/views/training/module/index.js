...
import { apiIndex as apiCategory } from '../category/api';
...
const Page = () => {
  ...
  const [levelModule, setLevelModule] = useState([]);
  ...
  const getCategory = async () => {
    try {
      const ress = await apiCategory({ type: 'collection' });
