...
export const Tools = (props) => {
  ...
  const handleExport = async () => {
    setIsExporting(true);
    await exportData('xlsx', apiExport, 'dokumen_siswa', props.localState.params);
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center space-x-[1rem]">
          ...
          {PageConfig.enableSearchTools && (
            <TableSearch size="md" placeholder="Cari dokumen" localState={props.localState} getData={props.getData} />
          )}
