...
export const Tools = (props) => {
  ...
  const handleExport = async () => {
    setIsExporting(true);
    await exportData('xlsx', apiExport, 'progres_siswa', props.localState.params);
        ...
        <div className="flex justify-end items-center space-x-[0.5rem]">
          ...
          {PageConfig.enableCreate && (
            <Button
              ...
              className="bg-white !px-3 !py-2 flex items-center !rounded"
            >
              <div className="mt-1 ml-1 !font-goth text-black !font-normal text-sm">Buat Progres</div>
            </Button>
          )}
        </div>
      </div>
