...
const Page = () => {
  ...
  const [localState, setLocalState] = useState({
    ...
    params: {
      ...
      order_by: 'updated_at',
      sort_by: 'desc',
      options: ['filter,role_id,is_not_null', 'filter,email,not_equal,implementer@62teknologi.com'],
      relations: ['role'].join(),
    },
  });
  ...
  return (
    <div className="px-7">
      ...
      <AdaptableCard bodyClass="!p-6" className="rounded-2xl border-none">
        <div className="text-black text-xl font-normal font-opificio mb-5">{PageConfig.pageTitle}</div>
